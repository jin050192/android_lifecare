...
public class lung {
    ...
    {
        StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1360000/HealthWthrIdxService/getAsthmaIdx"); /*URL*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("time","UTF-8") + "=" + URLEncoder.encode("2017060806", "UTF-8")); /*2017년 6월 8일 6시 발표*/
