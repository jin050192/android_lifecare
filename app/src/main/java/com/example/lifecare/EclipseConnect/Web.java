...
<<<<<<< Updated upstream
    public static String ip = "192.168.219.115"; //본인 IP
=======
    public static String ip = "192.168.35.101"; //본인 IP
>>>>>>> Stashed changes
    public static String servletURL = "http://" + ip + "/lifecare/android/"; //연결할 JSP URL
...
id : trump
dao m : spring.mvc.gsonEx.vo.Member@7834ae8d
m : spring.mvc.gsonEx.vo.Member@7834ae8d
     */
